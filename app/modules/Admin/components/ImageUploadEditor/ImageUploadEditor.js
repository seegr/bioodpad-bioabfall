...
import { locale, theme, transparentPixel } from "./ImageUploadEditorSettings.js"
...
function initImageEditor(source, input, image, thumbnail, modal = initModal()) {
  ...
  imageEditor.toDataURL = () => {
    return document
      .querySelector("#imageEditor")
      .querySelector(".lower-canvas")
      .toDataURL(
        source.match(/data:image\/jpe?g;base64/g) ? "image/jpeg" : "image/png"
      )
  }
