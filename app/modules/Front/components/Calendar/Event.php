...
class Event {
	...
	public function __construct($label, $DateTimeStart, $DateTimeEnd = null, $type = null, $id = null) {
		$this->label = $label;
    ...
    public function setHtmlContent(Html $content): self
    {
	...
	public function setRender($event = null) {
		...
		$eventEl->setHtml($this->htmlContent ?? $this->label);
